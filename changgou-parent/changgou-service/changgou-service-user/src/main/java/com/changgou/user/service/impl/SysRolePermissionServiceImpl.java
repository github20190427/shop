...
import com.changgou.user.dao.SysRolePermissionMapper;
...
public class SysRolePermissionServiceImpl implements SysRolePermissionService {
    ...
    public Example createExample(SysRolePermission sysRolePermission){
        ...
        if(sysRolePermission!=null){
            // 角色编号
            if(!StringUtils.isEmpty(sysRolePermission.getRID())){
                    criteria.andEqualTo("RID",sysRolePermission.getRID());
            }
            // 权限编号
            if(!StringUtils.isEmpty(sysRolePermission.getPID())){
                    criteria.andEqualTo("PID",sysRolePermission.getPID());
            }
        }
        return example;
    }
