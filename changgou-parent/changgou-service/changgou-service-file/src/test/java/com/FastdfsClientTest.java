...
public class FastdfsClientTest {
    ...
    public void upload() throws Exception {
        ...
        String file = new ClassPathResource("fdfs_client.conf").getPath();
        String img = "F:\\intellij\\springmvcproject\\changgou\\changgou-parent\\changgou-service\\changgou-service-file\\src\\test\\java\\com\\123.jpg";
        //加载全局的配置文件
        ...
        String[] jpgs = storageClient.upload_file(img, "jpg", null);
